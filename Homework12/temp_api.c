...
void menu(){
	...
	printf("-f (имя файла.csv) - считать данные из файла.\n");
	printf("Примечание: аргументы -m  или -p можно вводить только совместно с аргументом -f!\n");
...
uint16_t loadStruct(sen* info){
	...
	addInfo(info, i++, 2025, 5, 23, 21, 54, 33);
