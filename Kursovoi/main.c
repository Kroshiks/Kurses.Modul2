...
int main(int argc, char **argv){
	...
	char* fileName;
	if(argc == 1)
		printf("\nДанная программа предназначена для вывода статистики температуры, собранной датчиком за определный период времени.\nДля просмотра полного функционала введите клю '-h'.\n\n");
	else
	{
